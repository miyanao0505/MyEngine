...
/// static member 定義
unique_ptr<SceneManager> SceneManager::sInstance_ = nullptr;

/// Singleton Instance を取得
SceneManager* SceneManager::GetInstance() {
	if (sInstance_ == nullptr) {
		sInstance_ = make_unique<SceneManager>(SceneManager::ConstructoKey{});
	}
